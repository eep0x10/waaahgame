...
_FACTION_WILDCARD_MAP = {
    ...
    'ANY_STORMCAST_ETERNALS': 'STORMCAST_ETERNALS',
    'ANY_SYLVANETH': 'SYLVANETH',
    'ANY_NIGHTHAUNT': 'NIGHTHAUNT',
    'ANY_CITIES_OF_SIGMAR': 'CITIES_OF_SIGMAR',
    'ANY_DAUGHTERS_OF_KHAINE': 'DAUGHTERS_OF_KHAINE',
    'ANY_KHARADRON_OVERLORDS': 'KHARADRON_OVERLORDS',
    'ANY_LUMINETH_REALM_LORDS': 'LUMINETH_REALM_LORDS',
    'ANY_MAGGOTKIN_OF_NURGLE': 'MAGGOTKIN_OF_NURGLE',
    'ANY_SLAVES_TO_DARKNESS': 'SLAVES_TO_DARKNESS',
    'ANY_DISCIPLES_OF_TZEENTCH': 'DISCIPLES_OF_TZEENTCH',
    'ANY_SOULBLIGHT_GRAVELORDS': 'SOULBLIGHT_GRAVELORDS',
    'ANY_OSSIARCH_BONEREAPERS': 'OSSIARCH_BONEREAPERS',
    'ANY_ORRUK_WARCLANS': 'ORRUK_WARCLANS',
    'ANY_GLOOMSPITE_GITZ': 'GLOOMSPITE_GITZ',
    'ANY_ORDER': 'ORDER',
    'ANY_CHAOS': 'CHAOS',
